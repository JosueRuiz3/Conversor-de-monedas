...
public class MenuDeOpciones {
    ...
    public Double leerCantidadACambiar(String monedaBase, String monedaFinal){
        System.out.println("**********************************************************************************");
        System.out.println("Seleccione la cantidad que desea cambiar de " +monedaBase+ " a " + monedaFinal + ":");
        Scanner lectura = new Scanner(System.in);
        double cantidad;
    ...
    public Double cantidadObtenida(String monedaBase, Double cantidadCambiar, Double tasaDeConversion, String monedaFinal){
        ...
        System.out.println("**********************************************************************************");
        System.out.println("Este es el resultado de la conversion de " + monedaBase + " a " + monedaFinal);
